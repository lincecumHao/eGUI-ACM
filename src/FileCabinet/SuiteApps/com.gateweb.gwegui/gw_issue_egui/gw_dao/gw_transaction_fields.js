define(['../../library/ramda.min'], function (ramda) {
    ...
    var fieldConfig = {
        ...
        'item.custitem_ntt_item_model': {
            ...
            outputField: 'item.custitem_ntt_item_model',
            name: 'custitem_ntt_item_model',
            join: 'item',
        }, 
        'custcol_ntt_td_grade': {
            id: 'custcol_ntt_td_grade',
            sourceField: 'custcol_ntt_td_grade',
            outputField: 'custcol_ntt_td_grade',
        ...
        custcol_ntt_iv_itemname: {
            ...
            outputField: 'custcol_ntt_iv_itemname',
            name: 'custcol_ntt_iv_itemname',
            join: '',
        }, 
        otherrefnum: {
            id: 'otherrefnum',
            sourceField: 'otherrefnum',
            outputField: 'otherrefnum',
            name: 'otherrefnum',
            join: '',
        }, 
        custcol_scm_customerpartnumber: {
            id: 'custcol_scm_customerpartnumber',
            sourceField: 'custcol_scm_customerpartnumber',
            outputField: 'custcol_scm_customerpartnumber',
            name: 'custcol_scm_customerpartnumber',
            join: '',
        }, 
        'customer.custentity_ntt_iv_check_show_level': {
            id: 'customer.custentity_ntt_iv_check_show_level',
            sourceField: 'customer.custentity_ntt_iv_check_show_level',
            outputField: 'customer.custentity_ntt_iv_check_show_level',
            name: 'custentity_ntt_iv_check_show_level',
            join: 'customer',
        },
        'customer.custentity_ntt_multiple_email': {
            id: 'customer.custentity_ntt_multiple_email',
            sourceField: 'customer.custentity_ntt_multiple_email',
            outputField: 'customer.custentity_ntt_multiple_email',
